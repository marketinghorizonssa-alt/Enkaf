...
function performance_ready_html(string $html, string $path): string {
    // Remove the normal render-blocking CSS links. The complete visual system is
    // still loaded, but asynchronously after a compact above-the-fold critical layer.
...
if ($path === '/healthz/') {
    ...
    echo json_encode([
        ...
        'build' => BUILD_ID . '-v5-legal-about-seo-lcp',
